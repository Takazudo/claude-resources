---
title: "netlify-cli"
description: "Use this skill when writing or debugging GitHub Actions workflows that deploy to Netlify using `netlify-cli`, or when running `netlify dev` / `netlify functions:serve` locally. This skill contains cri..."
---
