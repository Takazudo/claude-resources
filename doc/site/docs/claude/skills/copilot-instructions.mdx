...
description: "Generate or update the .github/copilot-instructions.md file for GitHub Copilot custom instructions. Use when: (1) User wants to create Copilot instructions for a project, (2) User asks to update or im..."
---
