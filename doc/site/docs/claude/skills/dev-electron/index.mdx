---
title: "dev-electron"
description: "Electron app development patterns for thin wrapper apps around dev servers.
...
- [Background Process & Dev Server](./background-process.mdx)
- [Packaging & Build](./packaging.mdx)
- [BrowserWindow Patterns](./webview.mdx)
