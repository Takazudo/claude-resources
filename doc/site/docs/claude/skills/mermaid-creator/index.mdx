---
title: "mermaid-creator"
description: "ALWAYS use this skill proactively whenever generating, writing, or outputting Mermaid diagram code — whether in markdown code blocks, .md files, documentation, or any other context. This includes flow..."
---
...
- [Mermaid Syntax Guide](./syntax-guide.mdx)
