---
title: "w-update-wording-rule"
description: "Add or update wording rules (表記ルール) in the w repo's vocabulary-rule.md files. Use when: (1) User says 'add wording rule', 'update wording rule', '表記ルール追加', (2) User wants to add a new kanji/hiragana u..."
---
