---
title: "format-md"
description: "Format markdown (.md) and MDX (.mdx) files using @takazudo/mdx-formatter npm package. Use when: (1) User wants to format markdown files, (2) User mentions 'format md', 'prettify markdown', or 'fix mar..."
---
