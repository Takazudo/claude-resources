---
title: "sync-force-to"
description: "Force-sync current branch into a remote target branch by deleting the remote target and re-pushing. Before overwriting, creates a backup PR so the old state can be restored via GitHub's \"Restore bran..."
---
