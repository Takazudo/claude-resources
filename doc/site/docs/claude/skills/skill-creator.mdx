---
title: "skill-creator"
description: "Guide for creating effective Claude Code skills that extend capabilities with specialized knowledge, workflows, or tool integrations. Use when: (1) User wants to create a new skill, (2) User wants to ..."
---
...
- [Frontmatter Reference](./skill-creator/frontmatter.mdx)
- [Output Patterns](./skill-creator/output-patterns.mdx)
- [Workflow Patterns](./skill-creator/workflows.mdx)
