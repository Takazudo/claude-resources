---
title: "docusaurus-zudo-styles-develop"
description: "Apply zudo-style CSS to a Docusaurus site: Noto Sans JP font, orange oklch color palette, improved typography, sidebar styling, and responsive layout. Use when: (1) Setting up a new Docusaurus project..."
---
