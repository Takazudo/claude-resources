...
**Draft articles directory**: `$HOME/repos/w/zpaper/doc/src/content/docs/articles/`

Before writing, you MUST read these files in order:

1. `$HOME/repos/w/zpaper/CLAUDE.md` - Project rules
2. `$HOME/repos/w/zpaper/doc/src/content/docs/overview/writing-style.md` - Writing tone
3. `$HOME/repos/w/zpaper/doc/src/content/docs/overview/markdown-writing-rule.md` - Markdown rules
4. `$HOME/repos/w/zpaper/doc/src/content/docs/overview/vocabulary-rule.md` - Vocabulary rules
5. `$HOME/repos/w/zpaper/doc/src/content/docs/overview/tags.md` - Tag IDs and label conventions
6. `$HOME/repos/w/zpaper/doc/src/content/docs/overview/confidentiality-rule.md` - Confidentiality rules
