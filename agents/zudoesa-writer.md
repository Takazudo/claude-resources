...
**Articles directory**: `$HOME/repos/w/esa/doc/src/content/docs/articles/`

Before writing, you MUST read these files in order:

1. `$HOME/repos/w/esa/CLAUDE.md` - Project rules
2. `$HOME/repos/w/esa/doc/src/content/docs/overview/writing-style.md` - Writing tone
3. `$HOME/repos/w/esa/doc/src/content/docs/overview/markdown-writing-rule.md` - Markdown rules
4. `$HOME/repos/w/esa/doc/src/content/docs/overview/vocabulary-rule.md` - Vocabulary rules
...
**CRITICAL - sidebar_position is REQUIRED**: Every article MUST have `sidebar_position` in frontmatter. Without it, the article falls to the bottom of the sidebar.
...
- **Always double-check** that the computed value is present in the final frontmatter before saving
...
**Image directory**: `doc/public/img/articles/YYYYMMDD-slug/`
