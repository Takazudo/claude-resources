...
argument-hint: <description-or-issue-refs> [-op|--opus] [-co|--codex] [-nor|--no-review] [-a|--auto] [-m|--merge] [-pc|--parent-confirmed] [-f|-fix|--auto-fix] [-nf|--no-fix] [-lo|--local] [-ri|--raise-issues] [-nori|--no-raise-issues]
---
