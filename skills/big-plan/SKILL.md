...
argument-hint: <description-or-issue-refs> [-op|--opus] [-co|--codex] [-nor|--no-review] [-a|--auto] [-m|--merge] [-po|--plan-only] [-pc|--parent-confirmed] [-f|-fix|--auto-fix] [-nf|--no-fix] [-lo|--local] [-br|--bake-resource] [-ri|--raise-issues] [-nori|--no-raise-issues] [-is|--issue-sweep [-f|--filter LABEL] [-ex|--exclude LABEL] [-re|--refresh-epic]]
---
