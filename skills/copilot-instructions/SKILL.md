...
description: "Generate or update .github/copilot-instructions.md for GitHub Copilot. Use when: (1) User wants to create Copilot instructions, (2) User asks to update existing Copilot guidelines, (3) User mentions 'copilot instructions', 'copilot guidelines', or 'copilot config'. Explores codebase for tech stack, file conventions, import patterns, code style, testing. Creates actionable instructions with code examples."
---
